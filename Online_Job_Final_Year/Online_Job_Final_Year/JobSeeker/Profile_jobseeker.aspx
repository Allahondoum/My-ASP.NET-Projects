<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profile_jobseeker.aspx.cs" MasterPageFile="~/JobSeeker/JobSeekerMaster.Master" Inherits="Online_Job_Final_Year.JobSeeker.Profile_jobseeker" %>
            ...
            <div class="thumbnail">
                ...
                <div class="panel-body">
                    <center class="page-header">
                        <img class="img-responsive img-circle" width="200" height="200" src="../Images/avatar3.png" />
                        <h2>Allahondoum Innocent</h2>
             ...
             <div class="panel-body">
                ...
                <div class="tabbable-line">
                    <ul class="nav nav-tabs ">
                        <li class="active">
                            <a href="#tab_default_1" data-toggle="tab">About Her </a>
                        </li>
                        <li>
