					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<p>
								...
								<asp:CompareValidator ID="CompareValidatorPass" ControlToCompare="Password" ControlToValidate="Repassword" runat="server" ErrorMessage="Password does not match."></asp:CompareValidator>
							</p>


							<asp:Label runat="server" AssociatedControlID="drpSeekerLocation">Location<span style="color: red">*</span>: </asp:Label>
							<p>
								<asp:DropDownList CssClass="form-control" ID="drpSeekerLocation" runat="server" ToolTip="Select the location where you live">

								</asp:DropDownList>
								<asp:RequiredFieldValidator runat="server" ControlToValidate="drpSeekerLocation"
