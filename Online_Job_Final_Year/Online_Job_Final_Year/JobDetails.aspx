<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="JobDetails.aspx.cs" Inherits="Online_Job_Final_Year.JobDetails" %>
        ...
        <div class="row">
            ...
            <div class="col-md-3 Right-Side-JobDetails">
               ...
               <p><%#Eval("Specialization") %></p>
                ...
                <p><%#Eval("Deadline") %></p>
                <p>
                    <a class="btn btn-primary form-control" href="JobSubmission.aspx?item=<%# Eval("JobID")%>">Apply Now</a>
                    <%--<asp:Button runat="server" CssClass="btn btn-primary form-control" ID="btnAppply" Text="Apply" OnClick="btnAppply_OnClick"/>--%>
                </p>
